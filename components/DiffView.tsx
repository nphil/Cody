...
/** Shared monospace metrics for file/diff bodies. */
...
/** Shared gutter style for line numbers in file/diff bodies. */
...
/** Unified patch rendered with 3 lines of context around each change and the
 * unchanged stretches collapsed into a count row. Shared by the file viewer's
 * diff mode and the Git panel. */
