...
test("a missing state file reads as empty and not onboarded", () => {
  ...
  assert.deepEqual(state.readEngineState(), { version: 1, activeEngine: null, onboarded: false, setupDone: false, updatedAt: "" });
  assert.equal(state.isEngineOnboarded(), false);
  assert.equal(state.isSetupWizardDone(), false);
