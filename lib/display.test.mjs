...
const { claudeDisplayMcpConfig, createDisplayMcpLaunch } = await jiti.import("./display/engine-tools.ts");
...
test("the display MCP launcher carries a scoped capability into Claude", () => {
